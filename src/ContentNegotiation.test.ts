...
test.describe("ContentNegotiation.media", () => {
  ...
  test.it("returns matching type", () => {
    const result = ContentNegotiation.media("application/json", [
      "text/html",
      "application/json",
    ])
  ...
  test.it("returns empty array when no matching type", () => {
    const result = ContentNegotiation.media("text/plain", [
      "text/html",
      "application/json",
    ])
    test.expect(result).toEqual([])
  ...
  test.it("prefers exact match over wildcard", () => {
    const result = ContentNegotiation.media("text/*, text/html", [
      "text/plain",
      "text/html",
    ])
    test.expect(result).toEqual(["text/html", "text/plain"])
  ...
  test.it("returns empty array for invalid accept header", () => {
    const result = ContentNegotiation.media("invalid", [
      "text/html",
      "application/json",
    ])
    test.expect(result).toEqual([])
  ...
  test.describe("wildcard in available types", () => {
    test.it("text/* matches text/event-stream", () => {
      const result = ContentNegotiation.media("text/event-stream", [
        "text/*",
        "application/json",
      ])
    ...
    test.it("text/* matches multiple text types in Accept", () => {
      const result = ContentNegotiation.media("text/html, text/plain", [
        "text/*",
      ])
      test.expect(result).toEqual(["text/*"])
    })
    ...
    test.it("application/* matches application/xml", () => {
      const result = ContentNegotiation.media("application/xml", [
        "application/*",
        "text/html",
      ])
...
test.describe("ContentNegotiation.language", () => {
  ...
  test.it("returns languages sorted by quality", () => {
    const result = ContentNegotiation.language("en;q=0.5, fr;q=0.9", [
      "en",
      "fr",
    ])
  ...
  test.it("prefers exact match over prefix match", () => {
    const result = ContentNegotiation.language("en-US, en;q=0.9", [
      "en",
      "en-US",
    ])
  ...
  test.it("handles complex accept-language header", () => {
    const result = ContentNegotiation.language("en;q=0.8, es, pt", [
      "en",
      "es",
      "pt",
    ])
...
test.describe("ContentNegotiation.encoding", () => {
  ...
  test.it("returns encodings sorted by quality", () => {
    const result = ContentNegotiation.encoding("gzip;q=0.5, deflate;q=0.9", [
      "gzip",
      "deflate",
    ])
  ...
  test.it("excludes identity when identity;q=0", () => {
    const result = ContentNegotiation.encoding("gzip, identity;q=0", [
      "gzip",
      "identity",
    ])
  ...
  test.it("excludes unspecified encodings when *;q=0", () => {
    const result = ContentNegotiation.encoding("gzip, *;q=0", [
      "gzip",
      "deflate",
      "br",
    ])
...
test.describe("ContentNegotiation.charset", () => {
  ...
  test.it("returns matching charset", () => {
    const result = ContentNegotiation.charset("iso-8859-1", [
      "utf-8",
      "iso-8859-1",
    ])
