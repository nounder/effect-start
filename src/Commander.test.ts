...
test.describe(`${Commander.parse.name} - kebab-to-camel conversion`, () => {
  test.it("should convert kebab-case to camelCase", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--input-file", "test.txt"]))
  ...
  test.it("should handle single word options", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--port", "3000"]))
  ...
  test.it("should parse short options", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["-p", "8080"]))
  ...
  test.it("should override default when option specified", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--port", "8080"]))
...
test.describe("BooleanFromString", () => {
  test.it("should decode true value", async () => {
    const result = await Effect.runPromise(Schema.decode(Schema.BooleanFromString)("true"))

    test.expect(result).toBe(true)
  })

  test.it("should decode false value", async () => {
    const result = await Effect.runPromise(Schema.decode(Schema.BooleanFromString)("false"))
...
test.describe(`${Commander.choice.name}`, () => {
  test.it("should accept valid choice", async () => {
    ...
    const result = await Effect.runPromise(Schema.decode(ColorSchema)("red"))
  ...
  test.it("should fail on invalid choice", async () => {
    ...
    const result = await Effect.runPromise(Effect.either(Schema.decode(ColorSchema)("yellow")))
...
test.describe(`${Commander.repeatable.name}`, () => {
  test.it("should parse comma-separated values", async () => {
    ...
    const result = await Effect.runPromise(Schema.decode(schema)("foo,bar,baz"))
  ...
  test.it("should parse comma-separated numbers", async () => {
    ...
    const result = await Effect.runPromise(Schema.decode(schema)("1,2,3,4,5"))
  ...
  test.it("should encode back to string", async () => {
    ...
    const result = await Effect.runPromise(Schema.encode(schema)(["foo", "bar", "baz"]))
...
test.describe("integration", () => {
  test.it("should work with builder pattern", async () => {
    ...
    const result = await Effect.runPromise(
      Commander.parse(cmd, ["--input", "input.txt", "-f", "yaml"]),
    )
...
test.describe("boolean options", () => {
  ...
  test.it("should return true for boolean flag when specified", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--verbose", "true"]))
...
test.describe("options with choices", () => {
  test.it("should accept valid choice", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--color", "red"]))
...
test.describe("action/handler", () => {
  test.it("should invoke handler with parsed options", async () => {
    ...
    const parsed = await Effect.runPromise(Commander.parse(cmd, ["--name", "test"]))
  ...
  test.it("should support async handlers", async () => {
    ...
    await Effect.runPromise(Commander.parse(cmd, ["--delay", "10"]))
  ...
  test.it("should pass all options to handler", async () => {
    ...
    await Effect.runPromise(Commander.parse(cmd, ["-i", "in.txt", "-o", "out.txt", "-v", "true"]))
  })
})
...
test.describe("option types", () => {
  test.it("should parse string option", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--name", "test"]))
  ...
  test.it("should parse number option", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--count", "42"]))
  ...
  test.it("should parse boolean option", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--enabled", "true"]))
...
test.describe("complex scenarios", () => {
  ...
  test.it("should handle repeatable options", async () => {
    ...
    const result = await Effect.runPromise(Commander.parse(cmd, ["--tags", "foo,bar,baz"]))
  ...
  test.it("should preserve option order independence", async () => {
    ...
    const result1 = await Effect.runPromise(Commander.parse(cmd, ["--first", "1", "--second", "2"]))

    const result2 = await Effect.runPromise(Commander.parse(cmd, ["--second", "2", "--first", "1"]))
