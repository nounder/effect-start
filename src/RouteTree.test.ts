...
test.describe("layer route", () => {
  ...
  test.it("prepends LayerRoute to all other routes when walking", () => {
    ...
    test
      .expect(Route.descriptor(RouteTree.walk(tree)))
      .toEqual([
      { path: "/admin", method: "*" },
