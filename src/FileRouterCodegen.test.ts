...
t.it("validateRouteModule returns false for invalid modules", () => {
  ...
  t.expect(FileRouterCodegen.validateRouteModule(null))
    .toBe(false)

  t.expect(FileRouterCodegen.validateRouteModule(undefined))
    .toBe(false)

  t.expect(FileRouterCodegen.validateRouteModule("string"))
    .toBe(false)

  t.expect(FileRouterCodegen.validateRouteModule(42))
    .toBe(false)
})
