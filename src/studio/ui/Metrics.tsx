...
function MetricValue(options: { metric: StudioStore.StudioMetricSnapshot }) {
...
function MetricCard(options: { metric: StudioStore.StudioMetricSnapshot }) {
  return (
...
export function MetricsGrid(options: { metrics: Array<StudioStore.StudioMetricSnapshot> }) {
