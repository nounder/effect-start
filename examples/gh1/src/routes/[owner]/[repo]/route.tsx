        ...
        <div class="pt-4">
          ...
          <div class="flex items-center gap-4 text-sm mb-4 flex-wrap">
            <span class="flex items-center gap-1 text-[#8b949e]">
              ...
              <span class="font-semibold text-[#e6edf3]">
                {Github.num(repoInfo.stargazers_count)}
              </span>{" "}
              stars
            </span>
            <span class="flex items-center gap-1 text-[#8b949e]">
              ...
              <span class="font-semibold text-[#e6edf3]">
                {Github.num(repoInfo.forks_count)}
              </span>{" "}
              forks
            </span>
            <span class="flex items-center gap-1 text-[#8b949e]">
              ...
              <span class="font-semibold text-[#e6edf3]">
                {Github.num(repoInfo.watchers_count)}
              </span>{" "}
              watching
            </span>
            {repoInfo.license && (
          ...
          <Ui.Tabs
            items={[
              ...
              {
                label: "Issues",
                href: Route.link("/:owner/:repo/issues", r),
                count: repoInfo.open_issues_count,
              },
              {
                label: "Pull requests",
                href: Route.link("/:owner/:repo/pulls", r),
              },
              {
                label: "Commits",
                href: Route.link("/:owner/:repo/commits", r),
              },
              {
                label: "Contributors",
                href: Route.link("/:owner/:repo/contributors", r),
              },
            ]}
          />
            ...
            <aside class="lg:w-[296px] shrink-0">
                ...
                <div class="mb-4 pb-4 border-b border-[#21262d]">
                  ...
                  {repoInfo.homepage && (
                    <a
                      ...
                      class="text-sm text-[#58a6ff] hover:underline flex items-center gap-1 mt-2"
                    >
                      <svg
                        width="16"
                        height="16"
              ...
              {languages && Object.keys(languages).length > 0 && (
                <div class="mb-4 pb-4 border-b border-[#21262d]">
                  ...
                  <Ui.LanguageBar languages={languages} />
                </div>
              )}
              ...
              <div class="text-sm text-[#8b949e] space-y-2">
                {repoInfo.has_issues && (
                  <a
                    href={Route.link("/:owner/:repo/issues", r)}
                    class="flex items-center gap-2 hover:text-[#58a6ff]"
                  >
                    <svg
                      width="16"
                      height="16"
