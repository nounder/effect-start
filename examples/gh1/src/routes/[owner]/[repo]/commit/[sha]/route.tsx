...
export default Route.get(
  Route.schemaPathParams(
    Schema.Struct({ owner: Schema.String, repo: Schema.String, sha: Schema.String }),
  ),
          ...
          <div class="space-y-3">
            {files.map((f) => (
              <div class="border border-[#21262d] rounded-md">
                ...
                {f.patch && (
                  <pre class="p-3 text-xs font-mono overflow-x-auto text-[#8b949e] leading-5 whitespace-pre">
                    {f.patch}
                  </pre>
                )}
              </div>
