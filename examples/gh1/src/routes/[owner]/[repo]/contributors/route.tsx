...
import { Layout, Tabs, ContributorCard, EmptyState } from "../../../../Ui.tsx"
...
export default Route.get(
  ...
  Route.html(function* (ctx) {
    ...
    const contributors = yield* Github.getRepoContributors(owner, repo, { per_page: 100 })
      ...
      <Layout>
        <div class="pt-4">
          ...
          <Tabs items={[
            ...
            { label: "Contributors", href: `/${path}/contributors`, count: contributors.length, active: true },
          ]} />

          {contributors.length === 0 ? (
            <EmptyState title="No contributors" description="This repository has no contributors" />
          ) : (
