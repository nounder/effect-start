...
`Traffic.ndjson` is a recording of real OpenTelemetry exporter traffic,
replayed by `test/studio/internal/OpenTelemetryTraffic.test.ts`. One JSON object per line:
