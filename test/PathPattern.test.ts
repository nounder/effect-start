...
import * as PathPattern from "effect-start/PathPattern"

test.describe(PathPattern.validate, () => {
  test.it("validates simple paths", () => {
    test.expect(PathPattern.validate("/users")).toEqual({ ok: true, segments: ["users"] })
    test
  ...
  test.it("validates unicode segments", () => {
    test.expect(PathPattern.validate("/用户")).toEqual({ ok: true, segments: ["用户"] })
  })

  test.it("validates segments with dots and dashes", () => {
    test.expect(PathPattern.validate("/my-page")).toEqual({ ok: true, segments: ["my-page"] })
    test.expect(PathPattern.validate("/file.txt")).toEqual({ ok: true, segments: ["file.txt"] })
  })
...
test.describe("Segments", () => {
  test.it("extracts literal segments", () => {
    test.expectTypeOf<PathPattern.Segments<"/users">>().toEqualTypeOf<["users"]>()
    test.expectTypeOf<PathPattern.Segments<"/users/posts">>().toEqualTypeOf<["users", "posts"]>()
  })

  test.it("extracts param segments", () => {
    test.expectTypeOf<PathPattern.Segments<"/users/:id">>().toEqualTypeOf<["users", ":id"]>()
  })
  ...
  test.it("extracts optional wildcard segments", () => {
    test.expectTypeOf<PathPattern.Segments<"/files/:path*">>().toEqualTypeOf<["files", ":path*"]>()
  })
...
test.describe("Params", () => {
  test.it("extracts required params", () => {
    test.expectTypeOf<PathPattern.Params<"/users/:id">>().toEqualTypeOf<{ id: string }>()
  })
  ...
  test.it("extracts optional wildcard params as optional", () => {
    test.expectTypeOf<PathPattern.Params<"/files/:path*">>().toEqualTypeOf<{ path?: string }>()
  })
...
test.describe(PathPattern.toRegex, () => {
  ...
  test.it("extracts optional wildcard params with :param*", () => {
    ...
    test.expect("/docs/api/users/create".match(regex)?.groups).toEqual({ path: "api/users/create" })
  })
...
test.describe(PathPattern.toExpress, () => {
  ...
  test.it("converts optional wildcard to two routes", () => {
    test.expect(PathPattern.toExpress("/docs/:path*")).toEqual(["/docs", "/docs/*path"])
  })
...
test.describe(PathPattern.toURLPattern, () => {
  ...
  test.it("preserves param modifiers", () => {
    ...
    test.expect(PathPattern.toURLPattern("/users/:id?")).toEqual(["/users/:id?"])
    test.expect(PathPattern.toURLPattern("/docs/:path+")).toEqual(["/docs/:path+"])
    test.expect(PathPattern.toURLPattern("/docs/:path*")).toEqual(["/docs/:path*"])
  })
...
test.describe(PathPattern.toReactRouter, () => {
  ...
  test.it("converts optional wildcard to two routes", () => {
    test.expect(PathPattern.toReactRouter("/docs/:path*")).toEqual(["/docs", "/docs/*"])
  })
...
test.describe(PathPattern.toHono, () => {
  ...
  test.it("converts optional wildcard to two routes with unnamed *", () => {
    test.expect(PathPattern.toHono("/docs/:path*")).toEqual(["/docs", "/docs/*"])
  })
...
test.describe(PathPattern.toEffect, () => {
  test.it("is alias for toHono", () => {
    test.expect(PathPattern.toEffect("/users/:id")).toEqual(PathPattern.toHono("/users/:id"))
    test.expect(PathPattern.toEffect("/docs/:path*")).toEqual(PathPattern.toHono("/docs/:path*"))
  })
})
...
test.describe(PathPattern.toBun, () => {
  ...
  test.it("expands optional params to two routes", () => {
    test.expect(PathPattern.toBun("/users/:id?")).toEqual(["/users", "/users/:id"])
  })
